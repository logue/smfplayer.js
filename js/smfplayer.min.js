...
u.S=function(b,a){var d=this,e;this.b&&(document.body.removeChild(this.b),this.b=q);a||(a=document.body);e=this.b=document.createElement("iframe");e.src=b||"http://www.g200kg.com/en/docs/gmplayer/";e.className="wml";a.appendChild(e);window.addEventListener("message",function(a){"link,ready"===a.data&&(d.h=!0,d.D(d.v))},s)};
