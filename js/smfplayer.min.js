...
function H(d,c){var e,b,a=[77,84,104,100,0,0,0,6,0,1,0,16,0,48],k,h,g;if(void 0!==d.j.copy){h=d.j.copy;k=h.length;e=Array(k);for(b=0;b<k;++b)e[b]=h.charCodeAt(b);b=e;h=b.length;b=[0,255,2].concat(G(h),b);c[0].unshift(b)}k=0;for(h=c.length;k<h;++k){var l=c[k];b=[];e=0;for(g=l.length;e<g;++e)Array.prototype.push.apply(b,l[e]);g=b.length;e=[77,84,114,107,g>>24&255,g>>16&255,g>>8&255,g&255];a=a.concat(e,b)}w&&(a=new Uint8Array(a));return a}
function G(d){for(var c=[];128<=d;)c.unshift(d&127|(0===c.length?0:128)),d>>>=7;c.unshift(d|(0===c.length?0:128));return c};function I(d,c){c=c||{};this.input=d;this.a=c.index||0;this.length=c.length||d.length-this.a;this.offset=this.a;this.padding=void 0!==c.padding?c.padding:!0;this.H=void 0!==c.bigEndian?c.bigEndian:!1}
I.prototype.parse=function(){var d=this.length+this.offset;for(this.n=[];this.a<d;){var c=this.input,e=this.a,b=void 0;this.n.push({type:String.fromCharCode(c[e++],c[e++],c[e++],c[e++]),size:b=this.H?(c[e++]<<24|c[e++]<<16|c[e++]<<8|c[e++])>>>0:(c[e++]|c[e++]<<8|c[e++]<<16|c[e++]<<24)>>>0,offset:e});e+=b;this.padding&&1===(e-this.offset&1)&&e++;this.a=e}};function J(d,c){var e=d.n[c];return void 0===e?null:e};function K(d,c){c=c||{};c.padding=!1;c.bigEndian=!0;this.input=d;this.a=c.index||0;this.m=0;this.l=new I(d,c);this.i=[];this.B=[]}K.prototype.parse=function(){var d,c;this.l.parse();d=J(this.l,this.m++);c=this.input;var e=d.offset;if(!d||"MThd"!==d.type)throw Error("invalid header signature");this.J=c[e++]<<8|c[e++];this.k=c[e++]<<8|c[e++];this.U=c[e++]<<8|c[e++];d=0;for(c=this.k;d<c;++d)L(this)};
function L(d){function c(){var c=0,d;do d=b[a++],c=c<<7|d&127;while(0!==(d&128));return c}var e=J(d.l,d.m++),b=d.input,a=e.offset,k,h,g,l=-1,n=-1,f,m=0,p;if(!e||"MTrk"!==e.type)throw Error("invalid header signature");for(var e=e.offset+e.size,x=[],s=[];a<e;){k=c();m+=k;p=a;k=b[a++];h=k>>4&15;g=k&15;8>h?(h=l,g=n,k=l<<4|n,a--,p--):(l=h,n=g);var C=[,,,,,,,,"NoteOff","NoteOn","NoteAftertouch","ControlChange","ProgramChange","ChannelAftertouch","PitchBend"];switch(h){case 8:case 9:case 10:case 11:case 13:case 14:f=
...
break;case 89:f=new A("KeySignature",0,m,[b[a++],b[a++]]);break;case 127:f=new A("SequencerSpecific",0,m,[w?b.subarray(a,a+=f):b.slice(a,a+=f)]);break;default:f=new A("Unknown",0,m,[h,w?b.subarray(a,a+=f):b.slice(a,a+=f)])}break;default:r.console.log("unknown message:",k.toString(16))}break;default:throw Error("invalid status");}h=a-p;p=w?b.subarray(p,p+h):b.slice(p,p+h);p[0]=k;f instanceof y&&"NoteOn"===f.b&&0===f.A&&(f.b=C[8],p=[128|f.I,f.w,f.A],w&&(p=new Uint8Array(p)));s.push(p);x.push(f)}d.i.push(x);
d.B.push(s)};function M(){this.h=5E5;this.g=!1;this.position=0;this.r=this.s=this.q=this.p=!1;this.G=1;this.v=16383}q=M.prototype;q.O=function(d){this.p=d};q.P=function(d){this.q=d};q.R=function(d){this.s=d};q.Q=function(d){this.r=d};q.stop=function(){var d,c;this.pause=!0;this.e=Date.now();if(this.c)for(d=this.c.contentWindow,c=0;16>c;++c)d.postMessage("midi,b"+c.toString(16)+",78,0","*")};q.M=function(){return this.c};
function N(d){d.stop();O(d);d.pause=!1;d.f=null;d.e=-1;d.C=null;d.D=null;d.o=null;d.length=0;clearTimeout(d.d);d.g?P(d):window.addEventListener("message",function(c){"link,ready"===c.data&&P(d)},!1)}function O(d){d.h=5E5;d.position=0}
q.play=function(){var d=this;if(!this.c)throw Error("WebMidiLink not found");this.g?(this.length=this.f.length,this.f instanceof Array&&this.position>=this.length&&(this.position=0),Q(this)):window.addEventListener("message",function(c){"link,ready"===c.data&&(d.g=!0,Q(d))},!1)};
function P(d){d=d.c.contentWindow;var c;d.postMessage("midi,F0,7E,7F,09,01,F7","*");for(c=0;16>c;++c)d.postMessage("midi,b"+c.toString(16)+",07,64","*"),d.postMessage("midi,b"+c.toString(16)+",0a,40","*"),d.postMessage("midi,e"+c.toString(16)+",00,40","*"),d.postMessage("midi,b"+c.toString(16)+",64,00","*"),d.postMessage("midi,b"+c.toString(16)+",65,00","*"),d.postMessage("midi,b"+c.toString(16)+",06,02","*"),d.postMessage("midi,b"+c.toString(16)+",26,00","*")}
q.T=function(d,c){var e=this,b;this.c&&(document.body.removeChild(this.c),this.c=null);var a=c?document.getElementById(c):document.body;b=this.c=document.createElement("iframe");b.src=d||"http://www.g200kg.com/en/docs/gmplayer/";b.className="wml";a.appendChild(b);window.addEventListener("message",function(a){"link,ready"===a.data&&(e.g=!0,e.F(e.v))},!1)};
q.F=function(d){var c;this.v=d;this.c&&(c=this.c.contentWindow,c.postMessage("midi,f0,7f,7f,04,01,"+[("0"+(d&127).toString(16)).substr(-2),("0"+(d>>7&127).toString(16)).substr(-2),"7f"].join(),"*"))};q.S=function(d){this.G=d};
function Q(d){function c(){var d=a[h].time,n=a.length,f,m,p=Date.now();if(e.pause)e.e=Date.now()-e.e;else{do{f=a[h].event;"SetTempo"===f.b&&(e.h=f.data[0]);"ControlChange"===f.b&&111===f.w&&(g[0]={pos:h});if("Marker"===f.b&&("A"===f.data[0]&&(g[0]={pos:h}),"B"===f.data[0]&&e.q&&g[0]&&"number"===typeof g[0].pos)){h=g[0].pos;e.d=setTimeout(c,0);e.position=h;return}if("Marker"===f.b&&(f=f.data[0].match(/^LOOP_(START|END)=ID:(\d+),COUNT:(-?\d+)$/)))if("START"===f[1])g[f[2]|0]=g[f[2]]||{pos:h,count:f[3]|
0};else if("END"===f[1]&&e.s){m=g[f[2]|0];if(0!==m.count){0<m.count&&m.count--;h=m.pos;e.d=setTimeout(c,0);e.position=h;return}g[f[2]|0]=null}k.postMessage(a[h++].webMidiLink,"*")}while(h<n&&a[h].time===d);h<n?(p=Date.now()-p,e.d=setTimeout(c,e.h/(1E3*b)*(a[h].time-d-p)*(1/e.G))):(window.postMessage("endoftrack","*"),e.p&&g[0]&&"number"===typeof g[0].pos?(h=g[0].pos,e.d=setTimeout(c,0)):e.r&&(O(e),Q(e)));e.position=h}}var e=d,b=d.C.U,a=d.f,k=d.c.contentWindow,h=d.position||0,g=[];d.pause?(d.d=setTimeout(c,
d.e),d.pause=!1,d.e=-1):d.d=setTimeout(c,d.h/1E3*b*d.f[0].time)}q.u=function(d){d=new K(d);N(this);d.parse();R(this,d)};q.N=function(d){d=new B(d);N(this);d.parse();this.u(E(d))};
function R(d,c){var e=d.f=[],b,a,k,h=d.o=[],g,l,n,f;a=c.i;b=Array(a.length);k=c.B;g=0;for(l=a.length;g<l;++g)b[g]=0;g=0;for(l=a.length;g<l;++g)for(b=a[g],n=0,f=b.length;n<f;++n)0===c.J&&"SequenceTrackName"===b[n].b&&(d.D=b[n].data[0]),"CopyrightNotice"===b[n].b&&h.push(b[n].data[0]),e.push({track:g,eventId:n,time:b[n].time,event:b[n],webMidiLink:"midi,"+Array.prototype.map.call(k[g][n],function(a){return a.toString(16)}).join(",")});e.sort(function(a,b){return a.time>b.time?1:a.time<b.time?-1:a.track>
b.track?1:a.track<b.track?-1:a.eventId>b.eventId?1:a.eventId<b.eventId?-1:0});d.C=c}q.L=function(){return this.D};q.K=function(){return this.o};t("SMF.Player",M);t("SMF.Player.prototype.play",M.prototype.play);t("SMF.Player.prototype.stop",M.prototype.stop);t("SMF.Player.prototype.loadMidiFile",M.prototype.u);t("SMF.Player.prototype.loadMldFile",M.prototype.N);t("SMF.Player.prototype.setLoop",M.prototype.Q);t("SMF.Player.prototype.setCC111Loop",M.prototype.O);t("SMF.Player.prototype.setFalcomLoop",M.prototype.P);t("SMF.Player.prototype.setMFiLoop",M.prototype.R);t("SMF.Player.prototype.setWebMidiLink",M.prototype.T);
t("SMF.Player.prototype.getWebMidiLink",M.prototype.M);t("SMF.Player.prototype.setTempoRate",M.prototype.S);t("SMF.Player.prototype.setMasterVolume",M.prototype.F);t("SMF.Player.prototype.getCopyright",M.prototype.K);t("SMF.Player.prototype.getSequenceName",M.prototype.L);}).call(this); //@ sourceMappingURL=smfplayer.min.js.map
