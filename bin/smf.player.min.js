...
function N(c){c.A();O(c);c.i=!1;c.h=null;c.g=-1;c.K=null;c.s=null;c.B=null;c.length=0;c.window.clearTimeout(c.c);c.j?P(c):c.window.addEventListener("message",function(d){"link,ready"===d.data&&P(c)},!1)}function O(c){c.l=5E5;c.b=0;P(c)}q.P=function(){var c=this;if(!this.a)throw Error("WebMidiLink not found");this.j?(this.length=this.h.length,this.h instanceof Array&&this.b>=this.length&&(this.b=0),Q(this)):this.window.addEventListener("message",function(d){"link,ready"===d.data&&(c.j=!0,Q(c))},!1)};
