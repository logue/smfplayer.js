...
a+=h)])}break;default:r.console.log("unknown message:",f.toString(16))}break;default:throw Error("invalid status");}k=a-p;p=b.subarray(p,p+k);p[0]=f;h instanceof x&&"NoteOn"===h.f&&0===h.a&&(h.f=C[8],p=new Uint8Array([128|h.b,h.F,h.a]));v.push(p);y.push(h)}c.l.push(y);c.G.push(v)};function M(){this.j=5E5;this.pause=!0;this.i=!1;this.b=0;this.D=this.H=this.C=this.B=!1;this.o=1;this.I=16383}q=M.prototype;q.U=function(c){this.B=c};q.V=function(c){this.C=c};q.X=function(c){this.H=c};q.W=function(c){this.D=c};q.w=function(){var c,d;this.pause=!0;this.g=Date.now();if(this.a)for(c=this.a.contentWindow,d=0;16>d;++d)c.postMessage("midi,b"+d.toString(16)+",78,0","*")};q.P=function(){return this.a};
function N(c){c.w();O(c);c.pause=!0;c.h=null;c.g=-1;c.J=null;c.K=null;c.A=null;c.length=0;c.b=0;r.window.clearTimeout(c.c);c.i?P(c):r.window.addEventListener("message",function(d){"link,ready"===d.data&&P(c)},!1)}function O(c){c.j=5E5;c.b=0;P(c);c.pause=!1}
q.S=function(){var c=this;if(!this.a)throw Error("WebMidiLink not found");this.i?(this.length=this.h.length,this.h instanceof Array&&this.b>=this.length&&(this.b=0),Q(this)):r.window.addEventListener("message",function(d){"link,ready"===d.data&&(c.i=!0,Q(c))},!1)};
...
q.$=function(c,d){d||(d="wml");var e=this,b,a=r.window.document.getElementById(d);this.a&&(this.a=a.innerHTML=null);b=this.a=r.window.document.createElement("iframe");b.src=c||"//cdn.rawgit.com/logue/smfplayer.js/gh-pages/wml.html";b.className="wml";a.appendChild(b);r.window.addEventListener("message",function(a){"string"===typeof a.data&&(a=a.data.split(","),"link"===a[0]&&("ready"===a[1]?(e.i=!0,e.v(e.I)):"progress"===a[1]&&r.console.log(a[2])))},!1)};
q.v=function(c){this.I=c;this.a&&this.a.contentWindow.postMessage("midi,f0,7f,7f,04,01,"+[("0"+(c&127).toString(16)).substr(-2),("0"+(c>>7&127).toString(16)).substr(-2),"7f"].join(),"*")};q.Z=function(c){this.o=c};
function Q(c){function d(){var c=a[k].time,n=a.length,h,m,p=Date.now();if(e.pause)e.g=Date.now()-e.g;else{do{h=a[k].event;"SetTempo"===h.f&&(e.j=h.data[0]);"ControlChange"===h.f&&111===h.F&&(g[0]={pos:k});if("Marker"===h.f&&("A"===h.data[0]&&(g[0]={pos:k}),"B"===h.data[0]&&e.C&&g[0]&&"number"===typeof g[0].pos)){k=g[0].pos;e.c=r.window.setTimeout(d,0);e.b=k;return}if("Marker"===h.f&&(h=h.data[0].match(/^LOOP_(START|END)=ID:(\d+),COUNT:(-?\d+)$/)))if("START"===h[1])g[h[2]|0]=g[h[2]]||{pos:k,count:h[3]|
0};else if("END"===h[1]&&e.H){m=g[h[2]|0];if(0!==m.count){0<m.count&&m.count--;k=m.pos;e.c=r.window.setTimeout(d,0);e.b=k;return}g[h[2]|0]=null}f.postMessage(a[k++].webMidiLink,"*")}while(k<n&&a[k].time===c);k<n?(p=Date.now()-p,e.c=r.window.setTimeout(d,e.j/(1E3*b)*(a[k].time-c-p)*(1/e.o))):(r.window.postMessage("endoftrack","*"),this.pause=!0,e.B&&g[0]&&"number"===typeof g[0].pos?(k=g[0].pos,e.c=r.window.setTimeout(d,0)):e.D&&(O(e),Q(e)));e.b=k}}var e=c,b=c.J.ba,a=c.h,f=c.a.contentWindow,k=c.b||
0,g=[];c.pause?(c.c=r.window.setTimeout(d,c.g),c.pause=!1,c.g=-1):c.c=r.window.setTimeout(d,c.j/1E3*b*c.h[0].time)}
q.s=function(c){c=new K(c);N(this);var d,e;d=c.a;e=d.length+d.b;for(d.c=[];d.a<e;){var b=d,a=b.g,f=b.a;b.c.push({type:String.fromCharCode(a[f++],a[f++],a[f++],a[f++]),size:a=b.i?(a[f++]<<24|a[f++]<<16|a[f++]<<8|a[f++])>>>0:(a[f++]|a[f++]<<8|a[f++]<<16|a[f++]<<24)>>>0,offset:f});f+=a;b.h&&1===(f-b.b&1)&&f++;b.a=f}d=J(c.a,c.c++);e=c.b;b=d.offset;if(!d||"MThd"!==d.type)throw Error("invalid header signature");c.aa=e[b++]<<8|e[b++];c.m=e[b++]<<8|e[b++];c.ba=e[b++]<<8|e[b++];d=0;for(e=c.m;d<e;++d)L(c);
R(this,c)};
q.R=function(c){c=new B(c);N(this);var d=c.b,e=c.a,b=c.g={},a=String.fromCharCode(d[e++],d[e++],d[e++],d[e++]);if("melo"!==a)throw Error("invalid MFi signature:"+a);b.ga=(d[e++]<<24|d[e++]<<16|d[e++]<<8|d[e++])>>>0;b.ca=(d[e++]<<16|d[e++])+e;b.ea=d[e++];b.fa=d[e++];b.m=d[e++];c.a=e;for(var d=c.b,e=c.a,b=c.c={},f;e<c.g.ca;)switch(a=String.fromCharCode(d[e++],d[e++],d[e++],d[e++]),f=d[e++]<<8|d[e++],a){case "titl":case "copy":case "vers":case "date":case "prot":b[a]=String.fromCharCode.apply(null,d.subarray(e,
e+=f));break;case "sorc":b[a]=d[e++];break;case "note":b[a]=d[e++]<<8|d[e++];break;default:b[a]=d.subarray(e,e+=f)}c.a=e;D(c);this.s(E(c))};
function R(c,d){var e=c.h=[],b,a,f,k=c.A=[],g,l,n,h;a=d.l;b=Array(a.length);f=d.G;g=0;for(l=a.length;g<l;++g)b[g]=0;g=0;for(l=a.length;g<l;++g)for(b=a[g],n=0,h=b.length;n<h;++n)0===d.aa&&"SequenceTrackName"===b[n].f&&(c.K=b[n].data[0]),"CopyrightNotice"===b[n].f&&k.push(b[n].data[0]),e.push({track:g,eventId:n,time:b[n].time,event:b[n],webMidiLink:"midi,"+Array.prototype.map.call(f[g][n],function(a){return a.toString(16)}).join(",")});e.sort(function(a,b){return a.time>b.time?1:a.time<b.time?-1:a.track>
b.track?1:a.track<b.track?-1:a.eventId>b.eventId?1:a.eventId<b.eventId?-1:0});c.J=d}q.O=function(){return this.K};q.L=function(){return this.A};q.N=function(){return this.b};q.Y=function(c){this.b=c};q.M=function(){return this.length};q.u=function(){this.a.contentWindow&&this.a.contentWindow.postMessage("midi,F0,7E,7F,09,01,F7","*")};q.T=function(){this.a.contentWindow&&this.a.contentWindow.postMessage("midi,b0,78,0","*")};t("SMF.Player",M);t("SMF.Player.prototype.play",M.prototype.S);t("SMF.Player.prototype.stop",M.prototype.w);t("SMF.Player.prototype.loadMidiFile",M.prototype.s);t("SMF.Player.prototype.loadMldFile",M.prototype.R);t("SMF.Player.prototype.setLoop",M.prototype.W);t("SMF.Player.prototype.setCC111Loop",M.prototype.U);t("SMF.Player.prototype.setFalcomLoop",M.prototype.V);t("SMF.Player.prototype.setMFiLoop",M.prototype.X);t("SMF.Player.prototype.setWebMidiLink",M.prototype.$);
t("SMF.Player.prototype.getWebMidiLink",M.prototype.P);t("SMF.Player.prototype.setTempoRate",M.prototype.Z);t("SMF.Player.prototype.setMasterVolume",M.prototype.v);t("SMF.Player.prototype.getCopyright",M.prototype.L);t("SMF.Player.prototype.getSequenceName",M.prototype.O);t("SMF.Player.prototype.getLength",M.prototype.M);t("SMF.Player.prototype.setPosition",M.prototype.Y);t("SMF.Player.prototype.getPosition",M.prototype.N);t("SMF.Player.prototype.sendGmReset",M.prototype.u);
t("SMF.Player.prototype.sendAllSoundOff",M.prototype.T);}).call(this); //# sourceMappingURL=smf.player.min.js.map
