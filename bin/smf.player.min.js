...
a+=h)])}break;default:r.console.log("unknown message:",f.toString(16))}break;default:throw Error("invalid status");}k=a-p;p=b.subarray(p,p+k);p[0]=f;h instanceof y&&"NoteOn"===h.f&&0===h.a&&(h.f=B[8],p=new Uint8Array([128|h.b,h.F,h.a]));v.push(p);x.push(h)}c.m.push(x);c.G.push(v)};function M(){this.l=5E5;this.j=!1;this.b=0;this.H=this.I=this.D=this.C=!1;this.u=1;this.J=16383;this.window=window}q=M.prototype;q.T=function(c){this.C=c};q.U=function(c){this.D=c};q.W=function(c){this.I=c};q.V=function(c){this.H=c};q.A=function(){var c,d;this.i=!0;this.g=Date.now();if(this.a)for(c=this.a.contentWindow,d=0;16>d;++d)c.postMessage("midi,b"+d.toString(16)+",78,0","*")};q.P=function(){return this.a};
function N(c){c.A();O(c);c.i=!1;c.h=null;c.g=-1;c.K=null;c.s=null;c.B=null;c.length=0;c.b=0;c.window.clearTimeout(c.c);c.j?P(c):c.window.addEventListener("message",function(d){"link,ready"===d.data&&P(c)},!1)}function O(c){c.l=5E5;c.b=0;P(c)}
q.S=function(){var c=this;if(!this.a)throw Error("WebMidiLink not found");this.j?(this.length=this.h.length,this.h instanceof Array&&this.b>=this.length&&(this.b=0),Q(this)):this.window.addEventListener("message",function(d){"link,ready"===d.data&&(c.j=!0,Q(c))},!1)};
function P(c){c=c.a.contentWindow;var d;for(d=0;16>d;++d)c.postMessage("midi,b"+d.toString(16)+",128,0","*"),c.postMessage("midi,b"+d.toString(16)+",07,64","*"),c.postMessage("midi,b"+d.toString(16)+",0a,40","*"),c.postMessage("midi,e"+d.toString(16)+",00,40","*"),c.postMessage("midi,b"+d.toString(16)+",64,00","*"),c.postMessage("midi,b"+d.toString(16)+",65,00","*"),c.postMessage("midi,b"+d.toString(16)+",06,02","*"),c.postMessage("midi,b"+d.toString(16)+",26,00","*")}
q.Y=function(c,d){d||(d="wml");var e=this,b,a=this.window.document.getElementById(d);this.a&&(this.a=a.innerHTML=null);b=this.a=this.window.document.createElement("iframe");b.src=c||"//cdn.rawgit.com/logue/smfplayer.js/gh-pages/wml.html";b.className="wml";a.appendChild(b);this.window.addEventListener("message",function(a){"link,ready"===a.data&&(e.j=!0,e.w(e.J))},!1)};
q.w=function(c){this.J=c;this.a&&this.a.contentWindow.postMessage("midi,f0,7f,7f,04,01,"+[("0"+(c&127).toString(16)).substr(-2),("0"+(c>>7&127).toString(16)).substr(-2),"7f"].join(),"*")};q.X=function(c){this.u=c};
