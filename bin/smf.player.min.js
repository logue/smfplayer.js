...
a+=k)])}break;default:r.console.log("unknown message:",f.toString(16))}break;default:throw Error("invalid status");}h=a-p;p=b.subarray(p,p+h);p[0]=f;k instanceof x&&"NoteOn"===k.g&&0===k.a&&(k.g=C[8],p=new Uint8Array([128|k.b,k.F,k.a]));v.push(p);y.push(k)}c.l.push(y);c.G.push(v)};function M(){this.j=5E5;this.pause=!0;this.i=!1;this.b=0;this.D=this.H=this.C=this.B=!1;this.o=1;this.I=16383}q=M.prototype;q.V=function(c){this.B=c};q.W=function(c){this.C=c};q.Y=function(c){this.H=c};q.X=function(c){this.D=c};q.w=function(){var c;this.pause=!0;this.h=Date.now();if(this.a)for(c=0;16>c;++c)r.postMessage("midi,b"+c.toString(16)+",78,0","*")};q.R=function(){return this.a};
