...
function N(c){c.A();O(c);c.i=!1;c.h=null;c.g=-1;c.K=null;c.s=null;c.B=null;c.length=0;clearTimeout(c.c);c.j?P(c):c.window.addEventListener("message",function(d){"link,ready"===d.data&&P(c)},!1)}function O(c){c.l=5E5;c.b=0}q.P=function(){var c=this;if(!this.a)throw Error("WebMidiLink not found");this.j?(this.length=this.h.length,this.h instanceof Array&&this.b>=this.length&&(this.b=0),Q(this)):this.window.addEventListener("message",function(d){"link,ready"===d.data&&(c.j=!0,Q(c))},!1)};
...
q.W=function(c,d){var e=this,b;this.a&&(document.body.removeChild(this.a),this.a=null);var a=d?document.getElementById(d):document.body;b=this.a=document.createElement("iframe");b.src=c||"https://cdn.rawgit.com/logue/smfplayer.js/gh-pages/wml.html";b.className="wml";a.appendChild(b);this.window.addEventListener("message",function(a){"link,ready"===a.data&&(e.j=!0,e.w(e.J))},!1)};
q.w=function(c){var d;this.J=c;this.a&&(d=this.a.contentWindow,d.postMessage("midi,f0,7f,7f,04,01,"+[("0"+(c&127).toString(16)).substr(-2),("0"+(c>>7&127).toString(16)).substr(-2),"7f"].join(),"*"))};q.V=function(c){this.u=c};
