...
b[e++],b[e++],b[e++]),b=this.bigEndian?(b[e++]<<24|b[e++]<<16|b[e++]<<8|b[e++])>>>0:(b[e++]|b[e++]<<8|b[e++]<<16|b[e++]<<24)>>>0,e));e+=b;this.padding&&1===(e-this.offset&1)&&e++;this.ip=e}getChunk(a){a=this.chunkList[a];return void 0===a?null:a}getNumberOfChunks(){return this.chunkList.length}}class a{constructor(a,e,d){this.type=a;this.size=e;this.offset=d}}},function(p,f,h){h.r(f);h.d(f,"default",function(){return n});var b=h(3),a=h(0);class n{constructor(a,d={}){d.padding=!1;d.bigEndian=!0;this.input=
