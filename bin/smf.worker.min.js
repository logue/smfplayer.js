/** @license smfplayer.js 2013 - imaya / GREE Inc. [ https://github.com/gree/smfplayer.js ] The MIT License */(function() {var q,r=this;function u(c,d){var e=c.split("."),b=r;e[0]in b||!b.execScript||b.execScript("var "+e[0]);for(var a;e.length&&(a=e.shift());)e.length||void 0===d?b[a]?b=b[a]:b=b[a]={}:b[a]=d}function v(c){var d=w;function e(){}e.prototype=d.prototype;c.da=d.prototype;c.prototype=new e;c.prototype.constructor=c;c.$=function(b,a,c){for(var e=Array(arguments.length-2),g=2;g<arguments.length;g++)e[g-2]=arguments[g];return d.prototype[a].apply(b,e)}};function w(c,d,e){this.g=c;this.time=e}function y(c,d,e,b,a,f){this.g=c;this.time=e;this.b=b;this.F=a;this.a=f}v(y);function z(c,d,e,b){this.g=c;this.time=e;this.data=b}v(z);function A(c,d,e,b){this.g=c;this.time=e;this.data=b}v(A);function B(c){var d;d=d||{};this.b=c;this.a=d.index||0}
...
function E(c){var d={timeDivision:48},e=d.tracks=[],d=d.plainTracks=[],b=c.m,a,f,k,g,l,n,h,m,p,x,t=[];for(h=0;16>h;++h)d[h]=[],t[h]=0;h=0;for(m=b.length;h<m;++h){a=b[h];g=[];l=n=p=0;for(x=a.length;p<x;++p)switch(f=a[p],l+=f.deltaTime,f.id=n,f.time=l,f.subType){case "Nop":break;case "Note":g[n++]=f;g[n]={id:n,type:"internal",subType:"NoteOff",time:l+f.length,key:f.key,voice:f.voice,velocity:f.velocity,octaveShift:f.octaveShift};n++;break;case "InstrumentHighPart":k=f;f=a[++p];if("InstrumentLowPart"!==
f.subType)throw Error("broken instrument");g[n]={id:n,type:"internal",subType:"ProgramChange",time:l,part:f.value.part,instrument:k.value.instrument<<6|f.value.instrument};n++;break;default:g[n++]=f}g.sort(function(a,b){return a.time>b.time?1:a.time<b.time?-1:a.id>b.id?1:a.id<b.id?-1:0});e[h]=[];l=p=0;for(x=g.length;p<x;++p){f=g[p];l=f.time;switch(f.subType){case "Note":k=F(f.key+45,f.octaveShift);a=4*h+f.voice;9===a&&(k-=10);d[a].push(G(l-t[a]).concat(144|a,k,2*f.velocity));break;case "NoteOff":k=
F(f.key+45,f.octaveShift);a=4*h+f.voice;9===a&&(k-=10);d[a].push(G(l-t[a]).concat(128|a,k,2*f.velocity));break;case "ProgramChange":a=4*h+f.part;d[a].push(G(l-t[a]).concat(192|a,f.instrument));break;case "SetTempo":k=288E7/(f.value.tempo*f.value.timeBase);a=0;d[a].push(G(l-t[a]).concat(255,81,3,k>>16&255,k>>8&255,k&255));break;case "Loop":k=f.value.count;k="LOOP_"+(0===f.value.point?"START":"END")+"=ID:"+f.value.id+",COUNT:"+(0===k?-1:k);a=0;d[a].push(G(l-t[a]).concat([255,6,k.length],k.split("").map(function(a){return a.charCodeAt(0)})));
break;case "MasterVolume":k=f.value;a=0;d[a].push(G(l-t[a]).concat(240,7,127,127,4,1,k,k,247));break;case "Modulation":a=4*h+f.value.part;d[a].push(G(l-t[a]).concat(176|a,1,2*f.value.depth));break;case "Volume":a=4*h+f.value.part;d[a].push(G(l-t[a]).concat(176|a,7,2*f.value.volume));break;case "Valance":a=4*h+f.value.part;d[a].push(G(l-t[a]).concat(176|a,10,2*(f.value.valance-32)+64));break;case "PitchBend":a=4*h+f.value.part;d[a].push(G(l-t[a]).concat(224|a,2*f.value.value,2*f.value.value));break;
case "PitchBendRange":a=4*h+f.value.part;d[a].push(G(l-t[a]).concat(176|a,100,0),[0,176|a,101,0],[0,176|a,6,2*f.value.value]);break;case "MasterCoarseTuning":a=4*h+f.value.part;d[a].push(G(l-t[a]).concat(176|a,100,0),[0,176|a,101,2],[0,176|a,6,2*f.value.value]);break;default:continue}t[a]=f.time}}return H(c,d)}function F(c,d){var e=[0,12,-24,-12];if(void 0!==e[d])return c+e[d];throw Error("invalid OctaveShift value:"+d);}
...
a+=h)])}break;default:r.console.log("unknown message:",f.toString(16))}break;default:throw Error("invalid status");}k=a-p;p=b.subarray(p,p+k);p[0]=f;h instanceof y&&"NoteOn"===h.g&&0===h.a&&(h.g=C[8],p=new Uint8Array([128|h.b,h.F,h.a]));t.push(p);x.push(h)}c.m.push(x);c.G.push(t)};function M(){this.window=window}M.prototype.b=function(){return 0};M.prototype.a=function(){return this.length};function N(){this.l=5E5;this.j=!1;this.b=0;this.H=this.I=this.D=this.C=!1;this.u=1;this.J=16383;this.window=window}q=N.prototype;q.R=function(c){this.C=c};q.S=function(c){this.D=c};q.U=function(c){this.I=c};q.T=function(c){this.H=c};q.A=function(){var c;this.i=!0;this.h=Date.now();if(this.a)for(c=0;16>c;++c)this.a.postMessage("midi,b"+c.toString(16)+",78,0")};q.N=function(){return this.a};
function O(c){c.A();P(c);c.i=!1;c.f=null;c.h=-1;c.K=null;c.s=null;c.B=null;c.length=0;c.window.clearTimeout(c.c);c.j?Q(c):c.a.addEventListener("message",function(d){"link,ready"===d.data&&Q(c)},!1)}function P(c){c.l=5E5;c.b=0;Q(c)}q.P=function(){var c=this;if(!this.a)throw Error("WebMidiLink not found");this.j?(this.length=this.f.length,this.f instanceof Array&&this.b>=this.f.length&&(this.b=0),R(this)):this.a.addEventListener("message",function(d){"link,ready"===d.data&&(c.j=!0,R(c))},!1)};
function Q(c){var d;for(d=0;16>d;++d)c.a.postMessage("midi,b"+d.toString(16)+",07,64"),c.a.postMessage("midi,b"+d.toString(16)+",0a,40"),c.a.postMessage("midi,e"+d.toString(16)+",00,40"),c.a.postMessage("midi,b"+d.toString(16)+",64,00"),c.a.postMessage("midi,b"+d.toString(16)+",65,00"),c.a.postMessage("midi,b"+d.toString(16)+",06,02"),c.a.postMessage("midi,b"+d.toString(16)+",26,00")}
q.W=function(c){var d=this;this.a=c;this.a.addEventListener("message",function(c){"link,ready"===c.data&&(d.j=!0,d.w(d.J))},!1)};q.w=function(c){this.J=c;this.a&&this.a.postMessage("midi,f0,7f,7f,04,01,"+[("0"+(c&127).toString(16)).substr(-2),("0"+(c>>7&127).toString(16)).substr(-2),"7f"].join())};q.V=function(c){this.u=c};
function R(c){function d(){var c=a[k].time,n=a.length,h,m,p=Date.now();if(e.i)e.h=Date.now()-e.h;else{do{h=a[k].event;"SetTempo"===h.g&&(e.l=h.data[0]);"ControlChange"===h.g&&111===h.F&&(g[0]={pos:k});if("Marker"===h.g&&("A"===h.data[0]&&(g[0]={pos:k}),"B"===h.data[0]&&e.D&&g[0]&&"number"===typeof g[0].pos)){k=g[0].pos;e.c=this.window.setTimeout(d,0);e.b=k;return}if("Marker"===h.g&&(h=h.data[0].match(/^LOOP_(START|END)=ID:(\d+),COUNT:(-?\d+)$/)))if("START"===h[1])g[h[2]|0]=g[h[2]]||{pos:k,count:h[3]|
0};else if("END"===h[1]&&e.I){m=g[h[2]|0];if(0!==m.count){0<m.count&&m.count--;k=m.pos;e.c=this.window.setTimeout(d,0);e.b=k;return}g[h[2]|0]=null}f.postMessage(a[k++].webMidiLink)}while(k<n&&a[k].time===c);k<n?(p=Date.now()-p,e.c=this.window.setTimeout(d,e.l/(1E3*b)*(a[k].time-c-p)*(1/e.u))):(this.window.postMessage("endoftrack","*"),e.C&&g[0]&&"number"===typeof g[0].pos?(k=g[0].pos,e.c=this.window.setTimeout(d,0)):e.H&&(P(e),R(e)));e.b=k}}var e=c,b=c.K.Y,a=c.f,f=c.a,k=c.b||0,g=[];c.i?(c.c=c.window.setTimeout(d,
c.h),c.i=!1,c.h=-1):c.c=c.window.setTimeout(d,c.l/1E3*b*c.f[0].time)}
q.v=function(c){c=new K(c);O(this);var d,e;d=c.a;e=d.length+d.b;for(d.c=[];d.a<e;){var b=d,a=b.f,f=b.a;b.c.push({type:String.fromCharCode(a[f++],a[f++],a[f++],a[f++]),size:a=b.i?(a[f++]<<24|a[f++]<<16|a[f++]<<8|a[f++])>>>0:(a[f++]|a[f++]<<8|a[f++]<<16|a[f++]<<24)>>>0,offset:f});f+=a;b.h&&1===(f-b.b&1)&&f++;b.a=f}d=J(c.a,c.c++);e=c.b;b=d.offset;if(!d||"MThd"!==d.type)throw Error("invalid header signature");c.X=e[b++]<<8|e[b++];c.o=e[b++]<<8|e[b++];c.Y=e[b++]<<8|e[b++];d=0;for(e=c.o;d<e;++d)L(c);S(this,
c)};
q.O=function(c){c=new B(c);O(this);var d=c.b,e=c.a,b=c.f={},a=String.fromCharCode(d[e++],d[e++],d[e++],d[e++]);if("melo"!==a)throw Error("invalid MFi signature:"+a);b.ca=(d[e++]<<24|d[e++]<<16|d[e++]<<8|d[e++])>>>0;b.Z=(d[e++]<<16|d[e++])+e;b.aa=d[e++];b.ba=d[e++];b.o=d[e++];c.a=e;for(var d=c.b,e=c.a,b=c.c={},f;e<c.f.Z;)switch(a=String.fromCharCode(d[e++],d[e++],d[e++],d[e++]),f=d[e++]<<8|d[e++],a){case "titl":case "copy":case "vers":case "date":case "prot":b[a]=String.fromCharCode.apply(null,d.subarray(e,
e+=f));break;case "sorc":b[a]=d[e++];break;case "note":b[a]=d[e++]<<8|d[e++];break;default:b[a]=d.subarray(e,e+=f)}c.a=e;D(c);this.v(E(c))};
function S(c,d){var e=c.f=[],b,a,f,k=c.B=[],g,l,n,h;a=d.m;b=Array(a.length);f=d.G;g=0;for(l=a.length;g<l;++g)b[g]=0;g=0;for(l=a.length;g<l;++g)for(b=a[g],n=0,h=b.length;n<h;++n)0===d.X&&"SequenceTrackName"===b[n].g&&(c.s=b[n].data[0]),"CopyrightNotice"===b[n].g&&k.push(b[n].data[0]),e.push({track:g,eventId:n,time:b[n].time,event:b[n],webMidiLink:"midi,"+Array.prototype.map.call(f[g][n],function(a){return a.toString(16)}).join(",")});e.sort(function(a,b){return a.time>b.time?1:a.time<b.time?-1:a.track>
b.track?1:a.track<b.track?-1:a.eventId>b.eventId?1:a.eventId<b.eventId?-1:0});c.K=d}q.M=function(){return this.s};q.L=function(){return this.B};u("SMF.Worker",N);u("SMF.Worker.prototype.play",N.prototype.P);u("SMF.Worker.prototype.stop",N.prototype.A);u("SMF.Worker.prototype.loadMidiFile",N.prototype.v);u("SMF.Worker.prototype.loadMldFile",N.prototype.O);u("SMF.Worker.prototype.setLoop",N.prototype.T);u("SMF.Worker.prototype.setCC111Loop",N.prototype.R);u("SMF.Worker.prototype.setFalcomLoop",N.prototype.S);u("SMF.Worker.prototype.setMFiLoop",N.prototype.U);u("SMF.Worker.prototype.setWebMidiLink",N.prototype.W);
u("SMF.Worker.prototype.getWebMidiLink",N.prototype.N);u("SMF.Worker.prototype.setTempoRate",N.prototype.V);u("SMF.Worker.prototype.setMasterVolume",N.prototype.w);u("SMF.Worker.prototype.getCopyright",N.prototype.L);u("SMF.Worker.prototype.getSequenceName",N.prototype.M);u("SMF.Worker.prototype.getLength",M.prototype.a);u("SMF.Worker.prototype.getPosition",M.prototype.b);}).call(this); //# sourceMappingURL=smf.worker.min.js.map
