...
a+=h)])}break;default:t.console.log("unknown message:",f.toString(16))}break;default:throw Error("invalid status");}k=a-p;p=b.subarray(p,p+k);p[0]=f;h instanceof y&&"NoteOn"===h.g&&0===h.a&&(h.g=B[8],p=new Uint8Array([128|h.b,h.F,h.a]));r.push(p);x.push(h)}c.m.push(x);c.G.push(r)};function M(){this.l=5E5;this.j=!1;this.b=0;this.H=this.I=this.D=this.C=!1;this.u=1;this.J=16383;this.window=window}q=M.prototype;q.R=function(c){this.C=c};q.S=function(c){this.D=c};q.U=function(c){this.I=c};q.T=function(c){this.H=c};q.A=function(){var c;this.i=!0;this.h=Date.now();if(this.a)for(c=0;16>c;++c)this.a.postMessage("midi,b"+c.toString(16)+",78,0")};q.N=function(){return this.a};
function N(c){c.A();O(c);c.i=!1;c.f=null;c.h=-1;c.K=null;c.s=null;c.B=null;c.length=0;c.window.clearTimeout(c.c);c.j?P(c):c.a.addEventListener("message",function(d){"link,ready"===d.data&&P(c)},!1)}function O(c){c.l=5E5;c.b=0;P(c)}q.P=function(){var c=this;if(!this.a)throw Error("WebMidiLink not found");this.j?(this.length=this.f.length,this.f instanceof Array&&this.b>=this.f.length&&(this.b=0),Q(this)):this.a.addEventListener("message",function(d){"link,ready"===d.data&&(c.j=!0,Q(c))},!1)};
...
b.track?1:a.track<b.track?-1:a.eventId>b.eventId?1:a.eventId<b.eventId?-1:0});c.K=d}q.M=function(){return this.s};q.L=function(){return this.B};u("SMF.Worker",M);u("SMF.Worker.prototype.play",M.prototype.P);u("SMF.Worker.prototype.stop",M.prototype.A);u("SMF.Worker.prototype.loadMidiFile",M.prototype.v);u("SMF.Worker.prototype.loadMldFile",M.prototype.O);u("SMF.Worker.prototype.setLoop",M.prototype.T);u("SMF.Worker.prototype.setCC111Loop",M.prototype.R);u("SMF.Worker.prototype.setFalcomLoop",M.prototype.S);u("SMF.Worker.prototype.setMFiLoop",M.prototype.U);u("SMF.Worker.prototype.setWebMidiLink",M.prototype.W);
u("SMF.Worker.prototype.getWebMidiLink",M.prototype.N);u("SMF.Worker.prototype.setTempoRate",M.prototype.V);u("SMF.Worker.prototype.setMasterVolume",M.prototype.w);u("SMF.Worker.prototype.getCopyright",M.prototype.L);u("SMF.Worker.prototype.getSequenceName",M.prototype.M);}).call(this); //# sourceMappingURL=smf.worker.min.js.map
