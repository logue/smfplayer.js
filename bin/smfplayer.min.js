...
function P(b){b.stop();b.f=5E5;b.position=0;b.pause=s;b.g=q;b.e=-1;b.B=q;b.C=q;b.o=q;b.length=0;clearTimeout(b.d);b.h?Q(b):window.addEventListener("message",function(a){"link,ready"===a.data&&Q(b)},s)}u.play=function(){var b=this;this.b||n(Error("WebMidiLink not found"));this.h?(this.length=this.g.length,this.g instanceof Array&&this.position>=this.length&&(this.position=0),R(this)):window.addEventListener("message",function(a){"link,ready"===a.data&&(b.h=!0,R(b))},s)};
function Q(b){b=b.b.contentWindow;var a;for(a=0;16>a;++a)b.postMessage("midi,b"+a.toString(16)+",07,64","*"),b.postMessage("midi,b"+a.toString(16)+",0a,40","*"),b.postMessage("midi,e"+a.toString(16)+",00,40","*"),b.postMessage("midi,b"+a.toString(16)+",64,00","*"),b.postMessage("midi,b"+a.toString(16)+",65,00","*"),b.postMessage("midi,b"+a.toString(16)+",06,02","*"),b.postMessage("midi,b"+a.toString(16)+",26,00","*")}
u.S=function(b,a){var d=this,e;this.b&&(document.body.removeChild(this.b),this.b=q);var c=!a?document.body:document.getElementById(a);e=this.b=document.createElement("iframe");e.src=b||"http://www.g200kg.com/en/docs/gmplayer/";e.className="wml";c.appendChild(e);window.addEventListener("message",function(a){"link,ready"===a.data&&(d.h=!0,d.D(d.v))},s)};
u.D=function(b){var a;this.v=b;this.b&&(a=this.b.contentWindow,a.postMessage("midi,f0,7f,7f,04,01,"+[("0"+(b&127).toString(16)).substr(-2),("0"+(b>>7&127).toString(16)).substr(-2),"7f"].join(),"*"))};u.R=t("F");
...
0};else if("END"===f[1]&&d.s){k=h[f[2]|0];if(0!==k.count){0<k.count&&k.count--;i=k.pos;d.d=setTimeout(a,0);d.position=i;return}h[f[2]|0]=q}g.postMessage(c[i++].webMidiLink,"*")}while(i<l&&c[i].time===b);i<l?(m=Date.now()-m,d.d=setTimeout(a,d.f/(1E3*e)*(c[i].time-b-m)*(1/d.F))):(window.postMessage("endoftrack","*"),d.p&&h[0]&&"number"===typeof h[0].pos?(i=h[0].pos,d.d=setTimeout(a,0)):d.r&&(b=d,b.f=5E5,b.position=0,R(d)));d.position=i}}var d=b,e=b.B.T,c=b.g,g=b.b.contentWindow,i=b.position||0,h=[];
b.pause?(b.d=setTimeout(a,b.e),b.pause=s,b.e=-1):b.d=setTimeout(a,b.f/1E3*e*b.g[0].time)}
